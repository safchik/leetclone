...
const Timer: React.FC<TimerProps> = () => {
    ...
    return (
        <div>
            {showTimer ? (
                <div className='flex items-center space-x-2 bg-dark-fill-3 p-1.5 cursor-pointer rounded hover:bg-dark-fill-2 duration-200'>
                ...
                <div
                    className='flex items-center p-1 h-8 hover:bg-dark-fill-3 duration-200 rounded cursor-pointer'
